...
<c:url value="/admin/them-sach" var="urlThemSach"/>
<c:url value="/admin/sach" var="urlDanhSach"/>
<ul class="app-menu">
    ...
    <li><a class="app-menu__item" href="${urlDanhSach}"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Quản lý sách</span></a></li>
    <li><a class="app-menu__item" href="${urlThemSach}"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Thêm sách</span></a></li>
